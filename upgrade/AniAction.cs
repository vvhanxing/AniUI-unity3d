...
public class AniAction : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (HitWall ==true && findObjectByRay==null)
        {
            actionType = "isDead";
            doAction(actionType);
        ...
        else if(HitWall ==true && findObjectByRay!=null)
        {
    ...
    void randomAction()
    {
        ...
        if (action && change_action)
        {
            ...
            if (actionType=="isRunning" || actionType=="isAttacking" || actionType=="isDead" ||actionType=="isJumping" || actionType=="isAttacking1")
            {
