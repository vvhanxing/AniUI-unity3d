...
public class creatBuiding : MonoBehaviour
{
                ...
                for (int j = 0; j < mapDiv; j++) 
                {
        ...
        
                    {
                        ...
                        if (layer == 0)
                        {
                            ...
                            randomRotate = Random.Range(RotateRange[0],RotateRange[1]);
                        ...
                        if (creatObj!=null)
                        {
                            ...
                            if(creatObj.GetComponent<CanStackObject>()!=null)
                            {
                                ...
                                if (creatObj.GetComponent<CanStackObject>().isFollowRoot==false)
                                {
                                    randomRotate = Random.Range(creatObj.GetComponent<CanStackObject>().itemRotateRange[0],creatObj.GetComponent<CanStackObject>().itemScaleRange[1]);
                                }
                                else if(layer>0)
                                {
                                    randomRotate = hit.collider.gameObject.transform.eulerAngles[1];
